...
$(function() {
    ...
    //quantity selector
    $(document).off('click', '.quantity-select .minus').on('click', '.quantity-select .minus', function(){
    	var newValue = parseInt($(this).parent().find('.number').text(), 10);
    	$(this).parent().find('.number').text(newValue>1?(newValue-1):newValue);
    });

    $(document).off('click', '.quantity-select .plus').on('click', '.quantity-select .plus', function(){
    	var newValue = parseInt($(this).parent().find('.number').text(), 10);
